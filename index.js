...
function render() {
	...
	sTable.optionsSet(tableOptions);
	sTable.render();
}
function destroy() {
	sTable.destroy();
...
function renderForce() {
	sTable.destroy();
	var options_new = sTable.optionsGet();
	options_new.columnDeleting = false;
	options_new.columnInserting = false;
	options_new.callbackColumnDeleting = undefined;
	options_new.callbackColumnInserting = undefined;
	sTable.optionsSet(options_new);
	sTable.render();
}
